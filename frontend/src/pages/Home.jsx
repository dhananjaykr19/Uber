...
const Home = () => {
  ...
  return (
    <div className='h-screen relative overflow-hidden'>
      <img className='w-16 absolute left-5 top-5 rounded-full' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWR7YHPVpJosZRCRBiah2DQ6c4jAejTG2_pg&s" alt="" />
